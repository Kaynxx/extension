...
- Native YouTube DRM/CORS, insan görsel kararı/canonical visual manifest, P2/P3 gerçek model–OCR–60 FPS ve P4 temporal model hâlâ açık; bu nedenle yayın/goal tamamlandı sayılmıyor.
...
| P1 performans               | Headless fiziksel GPU'da tamamlandı | Güncel 4×120, 24/30 FPS p95 8.20–10.20 ms              |
...
- Orijinal/iyileştirilmiş karşılaştırma: **mekanik olarak tamamlandı**; A/B kompozit ve overlay kontrolü mevcut, native YouTube manuel kontrolü açık.
